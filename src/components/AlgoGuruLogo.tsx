...
export function AlgoGuruLogo({ size = 80, showText = true, className = "" }: AlgoGuruLogoProps) {
  ...
  const height  = showText ? size * (370 / 400) : size * (160 / 140);
  ...
  return (
    ...
    >
      ...
      <g stroke="#1b1b1b" strokeWidth={showText ? 3 : 5} strokeLinecap="round" strokeLinejoin="round">
        ...
        {/* Glasses */}
        <circle cx="188" cy="90" r="8" fill="#fcd09f" strokeWidth={showText ? 2 : 3} />
        <circle cx="212" cy="90" r="8" fill="#fcd09f" strokeWidth={showText ? 2 : 3} />
        <line x1="196" y1="90" x2="204" y2="90" strokeWidth={showText ? 2 : 3} />

        {/* Eyebrows */}
        <path d="M 185 88 Q 188 85 191 88" fill="none" strokeWidth={showText ? 1 : 3} />
        <path d="M 209 88 Q 212 85 215 88" fill="none" strokeWidth={showText ? 1 : 3} />

        {/* Smile */}
        <path d="M 190 105 C 195 110, 205 110, 210 105 C 205 115, 195 115, 190 105 Z" fill="#ffffff" strokeWidth={showText ? 0 : 3} />
        ...
        <path
          ...
          fill="#ed7014"
        />
        <path d="M 165 50 C 180 70, 200 95, 220 95" fill="none" strokeWidth={showText ? 2 : 3} />
        <path d="M 235 50 C 220 70, 200 95, 180 95" fill="none" strokeWidth={showText ? 2 : 3} />
      </g>
