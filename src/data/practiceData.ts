    ...
    subtopics: [
      {
        ...
        description: "Hashing frequency, maps and basic array manipulation.",
        problems: [
          lcProblem({ id: "arr-hs-1", title: "Contains Duplicate", difficulty: "Easy", slug: "contains-duplicate", companies: ["Amazon", "Google", "Microsoft"] }),
          lcProblem({ id: "arr-hs-2", title: "Valid Anagram", difficulty: "Easy", slug: "valid-anagram", companies: ["Amazon", "Google", "Microsoft"] }),
          lcProblem({ id: "arr-hs-3", title: "Two Sum", difficulty: "Easy", slug: "two-sum", companies: ["Amazon", "Google", "Microsoft"] }),
          lcProblem({ id: "arr-hs-4", title: "Group Anagrams", difficulty: "Medium", slug: "group-anagrams", companies: ["Amazon", "Google", "Microsoft"] }),
          lcProblem({ id: "arr-hs-5", title: "Valid Sudoku", difficulty: "Medium", slug: "valid-sudoku", companies: ["Amazon", "Google", "Microsoft"] }),
          lcProblem({ id: "arr-hs-6", title: "Longest Consecutive Sequence", difficulty: "Medium", slug: "longest-consecutive-sequence", companies: ["Amazon", "Google", "Microsoft"] }),
        ],
      },
      {
      ...
      },
      {
        ...
        problems: [
          lcProblem({ id: "arr-sw-0", title: "Best Time to Buy and Sell Stock", difficulty: "Easy", slug: "best-time-to-buy-and-sell-stock", companies: ["Amazon", "Microsoft", "Paytm"] }),
    ...
    subtopics: [
      ...
      },
      {
        ...
        problems: [
          ...
          lcProblem({ id: "str-sw-7", title: "Longest Repeating Character Replacement", difficulty: "Medium", slug: "longest-repeating-character-replacement", companies: ["Amazon", "Google", "Microsoft"] }),
    ...
    subtopics: [
      {
        ...
        problems: [
          ...
          lcProblem({ id: "hp-tk-7", title: "Kth Largest Element in a Stream", difficulty: "Easy", slug: "kth-largest-element-in-a-stream", companies: ["Amazon", "Google", "Microsoft"] }),
          lcProblem({ id: "hp-tk-8", title: "Last Stone Weight", difficulty: "Easy", slug: "last-stone-weight", companies: ["Amazon", "Google", "Microsoft"] }),
    ...
    subtopics: [
      {
        ...
        problems: [
          ...
          lcProblem({ id: "tr-df-16", title: "Balanced Binary Tree", difficulty: "Easy", slug: "balanced-binary-tree", companies: ["Amazon", "Adobe", "Microsoft"] }),
          lcProblem({ id: "tr-df-17", title: "Subtree of Another Tree", difficulty: "Easy", slug: "subtree-of-another-tree", companies: ["Amazon", "Google", "Microsoft"] }),
          lcProblem({ id: "tr-df-18", title: "Count Good Nodes in Binary Tree", difficulty: "Medium", slug: "count-good-nodes-in-binary-tree", companies: ["Amazon", "Google", "Microsoft"] }),
    ...
    subtopics: [
      {
        ...
        problems: [
          ...
          lcProblem({ id: "bs-op-9", title: "Kth Smallest Element in a BST", difficulty: "Medium", slug: "kth-smallest-element-in-a-bst", companies: ["Amazon", "Google", "Microsoft"] }),
    ...
    subtopics: [
      ...
      },
      {
        ...
        problems: [
          ...
          lcProblem({ id: "gr-df-13", title: "Max Area of Island", difficulty: "Medium", slug: "max-area-of-island", companies: ["Amazon", "Google", "Microsoft"] }),
          lcProblem({ id: "gr-df-14", title: "Pacific Atlantic Water Flow", difficulty: "Medium", slug: "pacific-atlantic-water-flow", companies: ["Amazon", "Google", "Microsoft"] }),
