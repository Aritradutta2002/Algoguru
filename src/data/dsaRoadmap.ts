...
export const dsaRoadmap: Roadmap = {
  ...
  accent: "#C3A6F7",
  categories: [
    { label: "Linear", color: "#C3A6F7" },
    { label: "Trees & Heaps", color: "#A3D977" },
    { label: "Graphs", color: "#7BA7F8" },
    { label: "Algorithmic", color: "#E8D870" },
    { label: "DP", color: "#F7A8C3" },
    { label: "Math & Bits", color: "#5CD6C0" },
  ],
